...
> 1000개 동시 요청 환경에서 각 락의 성능 트레이드 오프를 분석을 통해 최선의 락을 선택하고 서비스 특성에 따른 락 선택 전략을 수립한 프로젝트
...
| **비관적 락** | 충돌 빈도가 높고, CPU 사용량을 최소화해야하는 서비스 <br/>단, DB 커넥션 점유 증가를 허용할 수 있는 경우  |
| **Redis 분산 락** | DB 병목을 분산해야 하는 서비스 <br/> 단, CPU 사용량 증가를 감수할 수 있는 경우 |
